...
module.exports = function (mapStore, mapActions) {
  ...
  return function (ComponentToWrap) {
    var Reactor = function (_React$Component) {
      _inherits(Reactor, _React$Component);

      function Reactor() {
        _classCallCheck(this, Reactor);

        return _possibleConstructorReturn(this, (Reactor.__proto__ || Object.getPrototypeOf(Reactor)).apply(this, arguments));
      }
    ...
    hoistStatics(Reactor, ComponentToWrap);
    return Reactor;
  };
};